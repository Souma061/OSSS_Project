  ...
  return (
    <div className="flex flex-col w-full h-full overflow-hidden">
      ...
      <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center pt-24 pb-12 px-4 md:px-6">
        ...
        <div className="absolute top-1/4 left-1/4 -z-10 w-96 h-96 bg-primary/20 blur-[128px] rounded-full translate-x-[-50%]"></div>
        <div className="absolute bottom-1/4 right-1/4 -z-10 w-96 h-96 bg-blue-500/20 blur-[128px] rounded-full translate-x-[50%]"></div>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 mt-4">
            <Button variant="gradient" size="lg" className="w-full sm:w-auto h-14 px-8 rounded-full text-md">
              Start a Project <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button variant="outline" size="lg" className="w-full sm:w-auto h-14 px-8 rounded-full text-md backdrop-blur-sm bg-background/50">
              View Our Work
            </Button>
          </motion.div>
        </motion.div>
      ...
      <section className="w-full py-24 px-4 md:px-6 container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <motion.div
            whileHover={{ y: -5 }}
            className="md:col-span-2 relative overflow-hidden rounded-3xl border border-border bg-card p-10 flex flex-col justify-between shadow-sm"
          >
            ...
            <div>
              ...
              <Typography variant="h3" className="mb-2">Tailor-Made Solutions</Typography>
            ...
            <Button variant="link" className="self-start p-0">Learn More <ArrowRight className="ml-1 h-4 w-4" /></Button>
          </motion.div>

          {/* Small Card 2 */}
          <motion.div
            whileHover={{ y: -5 }}
            className="relative overflow-hidden rounded-3xl border border-border bg-card p-8 flex flex-col shadow-sm"
          >
            <ShieldCheck className="h-10 w-10 text-primary mb-6" />
            <Typography variant="h4" className="mb-2">Innovative System Integration</Typography>
            <Typography variant="muted" className="text-base text-muted-foreground flex-grow mb-6">
          ...
          <motion.div
            whileHover={{ y: -5 }}
            className="md:col-span-3 lg:col-span-1 relative overflow-hidden rounded-3xl border border-border bg-card p-8 flex flex-col shadow-sm"
          >
             <Cpu className="h-10 w-10 text-primary mb-6" />
            <Typography variant="h4" className="mb-2">Reliable Software Tools</Typography>
            <Typography variant="muted" className="text-base text-muted-foreground flex-grow mb-6">
          ...
          <motion.div
            whileHover={{ y: -5 }}
            className="md:col-span-3 lg:col-span-2 relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-primary/90 to-blue-900 p-10 flex flex-col justify-center items-center text-center shadow-lg group"
          >
             <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 mix-blend-overlay"></div>
             <Typography variant="h3" className="text-white mb-2 relative z-10 transition-transform group-hover:scale-105">Indian Railways Project</Typography>
             <Typography variant="muted" className="text-white/80 max-w-lg mb-6 relative z-10 mx-auto">
             ...
             <Button size="lg" className="bg-white text-primary hover:bg-white/90 rounded-full relative z-10 font-bold">
