  ...
  return (
    <div className="flex flex-col w-full h-full overflow-hidden">
      ...
      <section className="relative w-full min-h-[90vh] flex flex-col items-center justify-center pt-24 pb-12 px-4 md:px-6">
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            ...
            >
              Enterprise solutions for logistics leaders and production-grade
              MVPs for high-growth startups. Based in Kolkata, we deliver
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link href="/contact">
                <Button
                  variant="gradient"
                  size="lg"
                  className="w-full sm:w-auto h-14 px-8 rounded-full text-md group"
                >
                  Start a Project{" "}
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link href="/portfolio">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto h-14 px-8 rounded-full text-md backdrop-blur-sm bg-background/50 transition-colors hover:bg-background/80"
                >
                  View Our Work
                </Button>
              </Link>
      ...
      <section className="w-full py-12 border-y border-border bg-muted/30 overflow-hidden flex flex-col items-center">
        <Typography
          variant="muted"
          className="mb-6 uppercase tracking-widest font-semibold"
        >
        ...
        <div className="relative flex w-full max-w-[100vw] overflow-hidden group">
          <ul className="flex animate-marquee items-center gap-16 py-4 whitespace-nowrap min-w-full">
            ...
            <li className="font-semibold text-xl text-muted-foreground/50">
              TECHCORP
            </li>
            <li className="font-semibold text-xl text-muted-foreground/50">
              NEXUS LOGISTICS
      ...
      <section className="w-full py-12 md:py-24 px-4 md:px-6 container mx-auto">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <Typography variant="muted" className="max-w-xl text-lg mt-4">
            Custom software development for startups and large organizations,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                Our portfolio includes a range of tailor-made software
                solutions, designed to meet the unique needs of various
                industries, ensuring reliability and efficiency in every project
                we undertake.
              </Typography>
            </div>
          ...
          >
            ...
            <Typography
              variant="h4"
              className="mb-2 relative z-10 transition-colors group-hover:text-primary"
            >
              Innovative System Integration
            </Typography>
            <Typography
              variant="muted"
              className="text-base text-muted-foreground flex-grow mb-6 relative z-10"
            >
              Seamless integration solutions tailored to enhance your business
          ...
          >
            ...
            <Typography
              ...
              className="text-base text-muted-foreground flex-grow mb-6 relative z-10"
            >
              Efficient software tools designed to empower your operations and
          ...
          >
            ...
            <Typography
              variant="h3"
              className="text-white mb-2 relative z-20 transition-transform duration-500 group-hover:scale-105 group-hover:-translate-y-2"
            >
              Indian Railways Project
            </Typography>
            <Typography
              variant="muted"
              className="text-white/80 max-w-lg mb-6 relative z-20 mx-auto transition-transform duration-500 group-hover:-translate-y-1"
            >
              We proudly provide custom software solutions that enhance
              operational efficiency for Indian Railways, showcasing our
              commitment to quality and innovation in the transportation sector.
            </Typography>
            <motion.div
            ...
            >
              <Button
                size="lg"
                className="bg-white text-primary hover:bg-white/90 rounded-full font-bold shadow-xl flex items-center group/btn"
              >
