  ...
  return (
    <div className="flex flex-col w-full min-h-screen pt-24 pb-16 px-4 md:px-6 relative">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="flex flex-col items-center text-center mb-16 md:mb-24">
          ...
          >
            ...
            >
              Case Studies showcasing our massive integrations, like Indian
              Railways, down to sleek startup MVPs.
            </Typography>
          </motion.div>
        </div>
      ...
      <TestimonialsSection
        ...
        subtitle="Transformative software solutions tailored for various business needs."
      />
      {}
      <CTASection />
    </div>
