      ...
      <section className="px-4 md:px-6 container mx-auto max-w-5xl text-center mb-20">
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            <Typography
              variant="h1"
              className="mb-6 leading-tight max-w-4xl mx-auto"
            >
      ...
      <section className="container mx-auto px-4 md:px-6 max-w-6xl mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <Typography
              variant="h3"
              className="mb-3 transition-colors group-hover:text-primary"
            >
            ...
            >
              Custom software development tailored explicitly to your
              operational bottlenecks. We build robust, scalable applications
              from startups to large organizations, ensuring absolute
              reliability.
            </Typography>
            <ul className="flex flex-wrap gap-2 mt-auto mb-6 text-sm text-muted-foreground">
              <li className="font-mono text-xs font-semibold bg-muted/50 px-2.5 py-1 rounded-md text-foreground border border-border/50">
                Enterprise Web Apps
              </li>
              <li className="font-mono text-xs font-semibold bg-muted/50 px-2.5 py-1 rounded-md text-foreground border border-border/50">
                Scalable APIs
          ...
          >
            ...
            <Typography
              ...
              className="text-muted-foreground mb-6 flex-grow text-base leading-relaxed"
            >
              Seamlessly connect disparate tools and platforms. We build custom
              middleware and data pipelines that bridge the gaps in your
              technology stack, eliminating data silos.
            </Typography>
            <ul className="flex flex-wrap gap-2 mt-auto mb-6 text-sm text-muted-foreground">
              <li className="font-mono text-xs font-semibold bg-muted/50 px-2.5 py-1 rounded-md text-foreground border border-border/50">
                Custom Middleware
          ...
          >
            ...
            <Typography
              ...
              className="text-muted-foreground mb-6 flex-grow text-base leading-relaxed"
            >
              Efficient, targeted software tools designed to empower internal
              operations and meet specific, highly technical client needs with
            ...
            >
              ...
              <div className="flex flex-col gap-4 mb-8">
                <div className="flex items-start gap-3">
                  <div className="mt-1 h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center text-primary flex-shrink-0">
                    ✓
                  </div>
                  <Typography variant="p" className="text-muted-foreground m-0">
                    Massive-scale resource allocation dashboards.
                  </Typography>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center text-primary flex-shrink-0">
                  ...
                  <Typography variant="p" className="text-muted-foreground m-0">
                    Real-time scheduling and crew management nodes.
                  </Typography>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center text-primary flex-shrink-0">
                  ...
                  <Typography variant="p" className="text-muted-foreground m-0">
                    Fault-tolerant backend architecture handling millions of
                    events.
                  </Typography>
                </div>
              </div>
              ...
              >
                <Link href="/portfolio/1">
                  <Button
                    variant="gradient"
                    size="lg"
                    className="rounded-full shadow-lg group/btn h-14 px-8"
                  >
                    View the Case Study{" "}
        ...
        >
          ...
          >
            <Link href="/contact">
              <Button
                size="lg"
                className="rounded-full h-14 px-8 text-md group/btn shadow-xl"
              >
