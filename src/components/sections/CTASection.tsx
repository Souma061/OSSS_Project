...
export function CTASection() {
  return (
    <section className="w-full py-24 px-4 md:px-6 relative overflow-hidden">
      ...
      >
        <Typography variant="h2" className="mb-6">Ready to build something extraordinary?</Typography>
        <Typography variant="lead" className="text-muted-foreground max-w-2xl mx-auto mb-8">
          Let&apos;s discuss how our engineers can architect the perfect solution for your unique challenges.
        </Typography>
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block">
          <Link href="/contact">
            <Button variant="gradient" size="lg" className="rounded-full h-14 px-8 text-md group shadow-xl">
