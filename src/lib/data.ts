export const projects = [
  ...
  },
  {
    ...
    fullDescription: "NexLogix required a robust platform to managing complex supply chain logistics across multiple vendors and distributors. We engineered a scalable SaaS MVP using Next.js and Node.js that integrated real-time tracking, automated invoicing, and predictive inventory analytics. The solution successfully streamlined operations, resulting in a 30% reduction in overhead costs and rapid adoption among their B2B clients.",
